 ...
 * @returns {{currentView: string, currentProduct: string|null, showAddProductForm: boolean, showAddPriceForm: boolean}}
 */
 ...
 * @param {{currentView?: string, currentProduct?: string, showAddProductForm?: boolean, showAddPriceForm?: boolean}} partial - The state properties to update.
 */
